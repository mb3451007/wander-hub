                    ...
                    <div className={styles.card__arrows__arrowContainer}>
                        <div className={styles.card__arrows__arrowContainer__arrowLeft}>
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 25" fill="none">
                                <path d="M7.10091 12.5561L14.6009 5.0561C14.7075 4.95674 14.8486 4.90265 14.9943 4.90522C15.14 4.90779 15.2791 4.96683 15.3821 5.06989C15.4852 5.17295 15.5442 5.31199 15.5468 5.45771C15.5494 5.60344 15.4953 5.74447 15.3959 5.8511L8.29434 12.9536L15.3959 20.0561C15.4953 20.1627 15.5494 20.3038 15.5468 20.4495C15.5442 20.5952 15.4852 20.7343 15.3821 20.8373C15.2791 20.9404 15.14 20.9994 14.9943 21.002C14.8486 21.0046 14.7075 20.9505 14.6009 20.8511L7.10091 13.3511C6.99557 13.2456 6.9364 13.1027 6.9364 12.9536C6.9364 12.8045 6.99557 12.6616 7.10091 12.5561Z" fill="#343330" />
                            </svg>
                        </div>
                    </div>
                    <div className={styles.card__arrows__arrowContainer}>
                    ...
                    <div className={styles.card__cardContent__topSec__location}>
                        <div className={styles.card__cardContent__topSec__location__logo}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="25" viewBox="0 0 24 25" fill="none">
                                <path d="M4 11.0969C4 6.59949 7.58172 2.95361 12 2.95361C16.4183 2.95361 20 6.59949 20 11.0969C20 15.5591 17.4467 20.766 13.4629 22.628C12.5343 23.0621 11.4657 23.0621 10.5371 22.628C6.55332 20.766 4 15.5591 4 11.0969Z" stroke="black" strokeWidth="1.5" />
                                <path d="M12 13.9536C13.6569 13.9536 15 12.6105 15 10.9536C15 9.29676 13.6569 7.95361 12 7.95361C10.3431 7.95361 9 9.29676 9 10.9536C9 12.6105 10.3431 13.9536 12 13.9536Z" stroke="black" strokeWidth="1.5" />
                            </svg>
                        </div>
